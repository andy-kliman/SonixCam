...
/* Identify a device */
extern struct sn9c102_device* sn9c102_match_id(struct sn9c102_device* cam, const struct usb_device_id *id);

/* Attach a probed sensor to the camera. */
extern void sn9c102_attach_sensor(struct sn9c102_device* cam, const struct sn9c102_sensor* sensor);
...
extern int sn9c102_i2c_try_write(struct sn9c102_device*, const struct sn9c102_sensor*, uint8_t address, uint8_t value);
extern int sn9c102_i2c_try_read(struct sn9c102_device*, const struct sn9c102_sensor*, uint8_t address);
...
extern int sn9c102_i2c_try_raw_write(struct sn9c102_device* cam,
                                     const struct sn9c102_sensor* sensor, uint8_t n,
                                     uint8_t data0, uint8_t data1, uint8_t data2, uint8_t data3,
                                     uint8_t data4, uint8_t data5);
extern int sn9c102_i2c_try_raw_read(struct sn9c102_device* cam,
                                    const struct sn9c102_sensor* sensor,
                                    uint8_t data0, uint8_t data1, uint8_t n, uint8_t buffer[]);

/* To be used after the sensor struct has been attached to the camera struct */
extern int sn9c102_i2c_write(struct sn9c102_device*, uint8_t address, uint8_t value);
extern int sn9c102_i2c_read(struct sn9c102_device*, uint8_t address);

/* I/O on registers in the bridge. Could be used by the sensor methods too */
extern int sn9c102_read_reg(struct sn9c102_device*, uint16_t index);
extern int sn9c102_pread_reg(struct sn9c102_device*, uint16_t index);
extern int sn9c102_write_reg(struct sn9c102_device*, uint8_t value, uint16_t index);
extern int sn9c102_write_regs(struct sn9c102_device*, const uint8_t valreg[][2],
                              int count);
/*
